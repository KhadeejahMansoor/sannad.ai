    ...
    if (q) {
      ...
      const { rows } = await pool.query(
        `WITH chips AS (
         ...
         SELECT DISTINCT m.english AS narrator
           FROM machine_clauses m
          WHERE m.english ILIKE '%' || $1 || '%'
